...
property['color.black'] = 0x222827--0x1A1A1A
property['color.light_black'] = 0x323D3E-- 0x333333
--property['color.grey_black'] = 0x4D4D4D
property['color.dark_grey'] = 0x666666
property['color.grey'] = 0x222728 -- 0x808080
...
-- Default font.
property['font'], property['fontsize'] = 'Verdana',14 --'Bitstream Vera Sans Mono', 10
if WIN32 then
  property['font'] = 'Verdana',12 -- 'Courier New'
elseif OSX then
...
property['style.keyword'] = 'fore:$(color.kw)'
property['style.label'] = 'fore:$(color.orange)'
property['style.number'] = 'fore:$(color.nu)' --'fore:$(color.teal)'
...
property['style.string'] = 'fore:$(color.light_yellow)'
